...
void gen_response(const Request& req, Response& res2) {
    ...
    auto wea = clin.Get("/data/2.5/onecall?lat=44.952116&lon=34.102411&exclude=minutly,hourly,alerts,daily&appid=bf97b147726cfd116b9077cfa82459b5&lang=eng&units=metric");
