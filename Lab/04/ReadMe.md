...
Павленко Степан Владимирович<br>
...
### Задание 1
Вначале был скачан QT Creator с официального сайта, в процессе установки был выбран компонент Qt для сборки при помощи MinGW.
